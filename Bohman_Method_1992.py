...
def runoffVolumeUrbanBasinBohman1992V2(lat, lon, region3PercentArea, region4PercentArea, region3AEP, region4AEP, A, L, S, TIA):
    ...
    return LT, weightedQp, weightedVR


def computeUrbanFloodHydrographBohman1992(lat, lon, region3PercentArea, region4PercentArea, region3AEP, region4AEP, A, L, S, TIA):
    LT, weightedQp, weightedVR = runoffVolumeUrbanBasinBohman1992V2(lat, lon, region3PercentArea, region4PercentArea, region3AEP, region4AEP, A, L, S, TIA)
    ...
    region3DischargeRatio =    [0.07, 0.10, 0.15, 0.21, 0.28,
    ...
    region4DischargeRatio =    [None, 0.08, 0.12, 0.19, 0.28,
